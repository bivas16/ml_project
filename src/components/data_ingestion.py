import os 
import sys
from src.exception import Custom_Excpeption
...
class DataInjestion:
    ...
    def initiate_data_injestion(self):
        logging.info("entered the datainjestion method")
        try:
            df = pd.read_csv("notebook/data/stud.csv")
            logging.info("read the data file and stored in the dataframe")
            ...
            logging.info("Injestion is completed")
